                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <table border="0">
                            <tr>
                              <td style="width: 25%;">
                                <input type="text" id="cnic1" name="cnic1" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $admin->cnic1 }}" data-parsley-minlength="5" data-parsley-maxlength="5" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 50%;">  
                                <input type="text" id="cni2" name="cnic2" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $admin->cnic2 }}" data-parsley-minlength="7" data-parsley-maxlength="7" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 25%;">  
                                <input type="text" id="cnic3" name="cnic3" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $admin->cnic3 }}" data-parsley-minlength="1" data-parsley-maxlength="1" data-parsley-required="true" style="width: 100%;">
                              </td>
                            </tr>    
                          </table>
                        </div>
