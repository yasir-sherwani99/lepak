                  ...
                  <div class="x_content">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="cnic" name="cnic1" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $emp->cnic1 }}" data-parsley-minlength="5" data-parsley-maxlength="5" data-parsley-required="true" style="width: 15%;">
                          <input type="text" id="cnic" name="cnic2" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $emp->cnic2 }}" data-parsley-minlength="7" data-parsley-maxlength="7" data-parsley-required="true" style="width: 40%;">
                          <input type="text" id="cnic" name="cnic3" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" value="{{ $emp->cnic3 }}" data-parsley-minlength="1" data-parsley-maxlength="1" data-parsley-required="true" style="width: 10%;">
                        </div>
                      </div>
                       <div class="item form-group">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="img" type="file" name="img" data-parsley-required="true" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
