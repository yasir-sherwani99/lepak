                    ...
                    <form class="form-horizontal form-label-left" data-parsley-validate action="{{ action('EmployeeController@store') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="fname" placeholder="Enter first name" data-parsley-required="true" data-parsley-pattern="[a-zA-Z]+$" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <table border="0">
                            <tr>
                              <td style="width: 25%;">
                                <input type="text" id="cnic" name="cnic1" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 35202" data-parsley-minlength="5" data-parsley-maxlength="5" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 50%;">  
                                <input type="text" id="cnic" name="cnic2" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 1234567" data-parsley-minlength="7" data-parsley-maxlength="7" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 25%;">  
                                <input type="text" id="cnic" name="cnic3" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 1" data-parsley-minlength="1" data-parsley-maxlength="1" data-parsley-required="true" style="width: 100%;">
                              </td>
                            </tr>    
                          </table>
                        </div>
