                    ...
                    <div class="row">
                      <div class="col-md-3">
                          <a href="#" class="thumbnail" style="border: none;">
                             ...
                             @else
                               <img src="{{ asset('emp_images/' . $adm->image) }}" class="img-responsive img-circle"> 
                             @endif
                          </a>
                      </div>
                      <div class="col-md-6">
                        <h1>{{ $adm->fname }}&nbsp;{{ $adm->lname }}</h1>
                        <h3 style="color: #1ABC9C;">{{ $adm->designation }}</h3>
                        <p>
                            {{ $adm->email }}
                            <br/>
                            0{{ $adm->mobile }}
