              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" data-parsley-validate action="{{ URL::route('site.update', $site->id) }}" method="post">
                    <input type="hidden" name="_method" value="PUT">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input id="name" class="form-control col-md-7 col-xs-12" name="sname" value="{{ $site->siteName }}" data-parsley-required="true" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="location" class="form-control col-md-7 col-xs-12">
                            <option value="{{ $site->locationn['id'] }}">{{ $site->locationn['location'] }}</option>
                            @foreach($loc as $lloc)
