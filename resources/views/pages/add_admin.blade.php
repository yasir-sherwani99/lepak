              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" data-parsley-validate action="{{ action('AdminController@store') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <table border="0">
                            <tr>
                              <td style="width: 25%;">
                                <input type="text" id="cnic1" name="cnic1" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 35202" data-parsley-minlength="5" data-parsley-maxlength="5" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 50%;">  
                                <input type="text" id="cni2" name="cnic2" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 1234567" data-parsley-minlength="7" data-parsley-maxlength="7" data-parsley-required="true" style="width: 100%;">
                              </td>
                              <td style="width: 25%;">  
                                <input type="text" id="cnic3" name="cnic3" data-parsley-type="digits" class="form-control col-md-7 col-xs-12" placeholder="e.g. 1" data-parsley-minlength="1" data-parsley-maxlength="1" data-parsley-required="true" style="width: 100%;">
                              </td>
                            </tr>    
                          </table>
                        </div>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">Admin Picture <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
